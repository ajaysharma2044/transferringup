              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:ajay@transferringup.com" className="text-red-200 hover:text-white transition-colors">
                      ajay@transferringup.com
                    </a>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+16462462458" className="text-red-200 hover:text-white transition-colors">
                      (646) 246-2458
                    </a>
                  </div>
                </div>
            ...
            <div className="lg:hidden bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              ...
              <div className="space-y-2 text-sm">
                <div>
                  ...
                  <a href="mailto:ajay@transferringup.com" className="text-red-600 hover:underline">
                    ajay@transferringup.com
                  </a>
                </div>
                <div>
                  <span className="font-medium">Phone:</span>{' '}
                  <a href="tel:+16462462458" className="text-red-600 hover:underline">
                    (646) 246-2458
                  </a>
                </div>
              </div>
